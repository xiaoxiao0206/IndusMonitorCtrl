...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_8, GPIO_PIN_RESET);
...
/* USER CODE BEGIN 2 */
void GPIO_TogPin(GPIO_TypeDef *GPIOx, uint16_t GPIO_PIN)
{

  GPIOx->ODR ^= GPIO_PIN;
}

uint8_t GPIO_ReadPin_Register(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
