...
#define LFS_NO_MALLOC//决定使用动态内存还是静态内存
#define LFS_NO_ASSERT//决定是否使用断言
/*
#define LFS_YES_TRACE//决定是否使用LFS函数调用跟踪，调试时候可以打开
#define LFS_NO_DEBUG//决定是否使用调试信息输出
#define LFS_NO_ERROR//决定是否使用错误信息输出
#define LFS_NO_WARN//决定是否使用警告信息输出
*/
